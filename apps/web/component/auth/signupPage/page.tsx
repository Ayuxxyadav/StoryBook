        ...
        <div className="mt-8 space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full rounded-lg bg-zinc-800 border border-zinc-700 p-3 text-sm outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
            />
          </div>
          ...
          <button 
            ...
            className="w-full rounded-lg bg-white p-3 text-sm font-bold text-black transition-all hover:bg-zinc-200 active:scale-[0.98] disabled:opacity-50"
          >
